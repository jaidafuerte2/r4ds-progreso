...
# Función de googlesheets4 para leer hojas de cálculo de google
gs4_deauth()
#
...
# Igual que con read_excel(), podemos proporcionar nombres de 
# columnas, cadenas, NA (valores faltantes) y tipos de columnas:
students <- read_sheet(
  students_sheet_id,
  col_names = c("student_id", "full_name", "favourite_food", "meal_plan", "age"),
  skip = 1,
  na = c("", "N/A"),
  col_types = "dcccc" # son las iniciales de double, char, char, char y char
) # produce:
#> ✔ Reading from students.
#> ✔ Range 2:10000000.
#
...
# También es posible leer hojas de trabajo individuales desde hojas
# de cálculo de google:
penguins_sheet_id <- "1aFu8lnD_g0yjF5O-K6SFgSEWiHPpgvFCF0NY9D6LXnY"
read_sheet(penguins_sheet_id, sheet = "Torgersen Island") # produce:
...
# Obtener una lista de todas las hojas de trabajo dentro de una hoja
# de cálculo de google:
sheet_names(penguins_sheet_id) # produce:
#> [1] "Torgersen Island" "Biscoe Island"    "Dream Island"

# La función gs4_example localiza una hoja de cálculo que es parte 
# del paquete googlesheets4, que después usa read_sheet()
deaths_url <- gs4_example("deaths")
# Se puede especificar el rango de celdas que se necesitan leer
