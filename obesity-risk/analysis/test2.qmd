...
#| fig-height: 5
#| message: false
# message: false evita que aparezcan mensajes de advertencia
ggplot(
  data = obesity,
...
```{r}
#| label: diagrama-dispersión-imc-edad
#| echo: false 
#| warning: false
# echo: false evita que aparezca el código
# warning: false evita que aparezcan mensajes de advertencia
ggplot(
  data = obesity,
...
**NOTA IMPORTANTE:** El atajo para insertar un bloque de código de r es: ctrl+alt+i . El atajo para ejecutar un chunk es ctrl+mayús+intro
